...
- CI runs the full check on Node 22.16 and Node 24.
...
1. Install Node 22.16+, ffmpeg, Parakeet MLX, Ollama, and optionally yt-dlp.
...
- Node 22 prints an experimental warning for the built-in SQLite module. Chronicle requires
  Node 22.16 or newer because earlier Node 22 builds omit the FTS5 module used by search; CI
  covers Node 22.16 and Node 24.
